...
const register = asyncHandler(async (req, res) => {
  const result = await registerAdmin(res.app.locals.models, req.body)
  return res
...
const forgot = asyncHandler(async (req, res) => {
  await forgotPassword(res.app.locals.models, req.body.email, req.body.baseUrl)
  return res
...
const reset = asyncHandler(async (req, res) => {
  const result = await resetPassword(res.app.locals.models, req.body)
